...
(function(ClassNames2) {
  ...
  ClassNames2["emojiHasVariatios"] = "epr-emoji-has-variations";
...
function useGetEmojiUrlConfig() {
  var _usePickerConfig16 = usePickerConfig(), getEmojiUrl = _usePickerConfig16.getEmojiUrl;
  return getEmojiUrl;
}
...
function ClickableEmoji(_ref) {
  ...
  return (0, import_react.createElement)(Button, {
    className: clsx_m_default(ClassNames.emoji, (_clsx = {}, _clsx[ClassNames.hidden] = hidden, _clsx[ClassNames.hiddenOnSearch] = hiddenOnSearch, _clsx[ClassNames.visible] = !hidden && !hiddenOnSearch, _clsx[ClassNames.emojiHasVariatios] = hasVariations && showVariations, _clsx)),
